...
Два сервіси під PM2: **NestJS backend** (порт 3001) і **Next.js frontend** (порт 3000).
...
nano frontend/.env.production   # NEXT_PUBLIC_API_URL=http://<IP_або_домен>:3001
...
- Порти 3000/3001 назовні краще не відкривати — поставте попереду nginx/Caddy
  з TLS і проксуйте: `/` → 3000, а бекенд або на піддомен, або відкрийте 3001
  лише для потрібних мереж.
